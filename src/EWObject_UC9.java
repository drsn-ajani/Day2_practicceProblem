public class EWObject_UC9 {
    ...
    public EWObject_UC9(String Company, int wage_per_hour, int max_working_hour, int max_working_days) {
    ...
    public static void main(String[] args) {
        EWObject_UC9 Trends = new EWObject_UC9("Trends", 10, 140, 22);
        EWObject_UC9 Adidas = new EWObject_UC9("Adidas", 20, 120, 26);
