class CompanyEmpWage_UC11 implements EmpWage {
    ...
    public CompanyEmpWage_UC11(String Company, int emp_rate_per_hour, int max_working_hour, int max_working_days) {
...
public class EW_Interface_UC11 {
    private final int IS_PART_TIME = 1;
    private final int IS_FULL_TIME = 2;

    private int number_of_company = 0;
    public CompanyEmpWage_UC11[] CompanyEmpWageArray;

    public EW_Interface_UC11() {
        CompanyEmpWageArray = new CompanyEmpWage_UC11[5];
    }

    private void addCompany(String Company, int emp_rate_per_hour, int max_working_hour, int max_working_days) {
        CompanyEmpWageArray[number_of_company] = new CompanyEmpWage_UC11(Company, emp_rate_per_hour, max_working_hour, max_working_days);
        number_of_company++;
    }
    ...
    private int compute_wage(CompanyEmpWage_UC11 companyEmpWage) {
    ...
    public static void main(String[] args) {
        EW_Interface_UC11 empWageArray = new EW_Interface_UC11();
